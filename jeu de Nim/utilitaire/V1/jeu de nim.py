...
while running:
            ...
            # Délai pour chaque action
                ...
                # si c'est à la machine de jouer
                    ...
                    # sinon s'il n'y a plus de jetons dans le gobelet qu'elle prend
                        ...
                        affichage_machine = police.render(f"La machine a choisi d'abandonner", 1, (255,255,255) )
                        screen.blit(affichage_machine,(715, 500))
                        pygame.display.flip()
    ...
    if jeu_termine:# si le jeu est fini
        ...
        if gagne or abandonner:
            ...
            affichage_gagne = police.render(f'Bravo tu as gagné !!!!!!', 1, (255,255,255) )
        ...
        if gagne:
            screen.blit(affichage_gagne,(250, 150))
