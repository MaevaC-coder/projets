...
def refresh():
    ...
    # on affiche le score et le nombre de lignes complétées VERSION PETIT ECRAN
    ...
    screen.blit(lignes_affichage,(680, 70))
    ...
    next_affichage = police.render(f'NEXT', 1, (255,255,255) )
    screen.blit(next_affichage,(680, 120))
    screen.blit(rect_prochaine_piece, (680, 165))
...
while running:
    ...
    if play:
        ...
        prochaine_piece = Carre(couleur_prochaine_piece, 700, 238-55*hauteur_proch_piece, prochaine_piece_forme)
    ...
    if perdu:# si on a perdu
        ...
        screen.blit(fond_cote,(660, 0)) # on doit superposer un rectangle noir sur le côté pour ne plus voir les infos précédentes
        score_affichage_defaite = police.render(f'Score : {score}', 1, (255,0,0) )
        screen.blit(score_affichage_defaite,(680, 20))
