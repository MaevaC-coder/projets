...
def supprimer_ligne(matrice_j,taille_c):
    ...
    # toutes les n lignes on accélère la vitesse tant qu'on a pas atteint la vitesse max
    ...
    acceleration_affichage = police_tetris.render(f'acceleration', 1, (255,255,255) )
